...
/// <summary>
/// 文本控件，支持超链接、图片
/// this.View.ContentText.text = "巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉<a href=\"https://www.baidu.com/\">点击我</a>巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉,巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉<a href=\"https://www.souhu.com/\">www.souhu.com</a>巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉";
/// this.View.ContentText.onHrefClick.AddListener((string href)=>{ });
/// </summary>
...
public class LinkImageText : Text, IPointerClickHandler
{
    ...
    protected virtual string GetOutputText(string outputText)
    {
        ...
        foreach (Match match in s_HrefRegex.Matches(outputText))
        {
            ...
            s_TextBuilder.Append("<color=#F4FF3AFF>");  // 超链接颜色
